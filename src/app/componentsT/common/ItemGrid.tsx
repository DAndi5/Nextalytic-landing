...
// import type  ItemGrid from '@/shared/types';
// import ItemGridType  from '@/shared/types';
                  ...
                  {callToAction && (
                    <CTA
                      ...
                      linkClass={twMerge(
                        ...
                        } text-inherit font-bold text-blue-600 hover:underline dark:text-gray-200 cursor-pointer`,
                        actionClass,
                      )}
                    />
                  )}
