        ...
        <div className='flex gap-12 lg:flex-nowrap flex-wrap'>
          <div className='flex flex-col lg:gap-0 gap-4 justify-between lg:w-[30%] w-full'>
            <div className='flex flex-col lg:gap-3 gap-1'>
              <div
                className='bg-[#FEE1BD] py-0.5 mb-4 font-normal border-[1px] rounded-2xl border-[#EFCA9C] px-3.5 w-fit'>
                <h1 className='font-inter lg:text-sm text-xs'>About Nextalytic</h1>
              </div>
              <h1
                className='xl:text-5xl lg:text-[2.5rem] sm:text-4xl text-2xl text-[#091438] font-manrope font-medium'>See
                More Case Studies Here.</h1>
            </div>
            <div className='lg:w-auto w-full flex lg:justify-normal justify-end'>
              <button
                className='text-white flex sm:gap-3 gap-1 group hover:scale-105 transition-all duration-200 bg-[#091438] font-inter sm:text-base text-xs sm:px-5 px-3 sm:py-3 py-2 rounded-3xl'>Explore
                All Case Studies <FiArrowUpRight
                  className='sm:text-xl text-base group-hover:rotate-45 transition-all duration-200'/></button>
            </div>
          </div>
