...
import useCollapse from '@/app/componentsT/hooks/useCollapse';
          ...
          <div className={classCollapseItem}>
            ...
            >
              ...
              {iconDown && iconUp ? (
                ...
                <IconChevronUp className="h-6 w-6 text-slate-600 dark:text-slate-200"/>
              ) : (
                <IconChevronDown className="h-6 w-6 text-slate-600 dark:text-slate-200"/>
              )}
            </div>
            {activeIndex === index && (
              <div
