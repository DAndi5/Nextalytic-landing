...
const Testimonials2 = () => {
  ...
  const testimonials = testimonialsHome.testimonials;
  const id = testimonialsHome.id;
  const header = testimonialsHome.header;
  const isTestimonialUp = testimonialsHome.isTestimonialUp;
  const hasBackground = testimonialsHome.hasBackground;
          ...
          ({name, job, testimonial, image}, index) =>
            testimonial && (
              ...
              >
                ...
                <div
                  className="md:absolute md:inset-0 flex items-center justify-center md:justify-between p-4 mb-6 md:mb-0">
