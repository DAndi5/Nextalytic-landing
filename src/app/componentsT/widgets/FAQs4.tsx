...
import useWindowSize from '@/app/componentsT/hooks/useWindowSize';
                    ...
                    return (
                      <li
                        ...
                        className={`mb-5 flex cursor-pointer items-center ${
                          activeTab === index ? 'text-slate-600 dark:text-slate-200' : ''
                        }`}
                        tabIndex={0}
                        onClick={onSelectTab}
                      >r
              ...
              <div key={`tab-${index}`} className="">
                {activeTab === index && (
                  <Collapse
                    ...
                    iconUp={<IconMinus className="h-6 w-6 text-slate-600 dark:text-slate-200" />}
                    iconDown={<IconPlus className="h-6 w-6 text-slate-600 dark:text-slate-200" />}
                  />
                )}
              </div>
            ))}
