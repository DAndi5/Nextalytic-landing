  ...
  return (
    <>
      <div className='w-full sm:h-screen'>
        <div
          className='hero-bg relative w-full flex flex-col sm:h-full xl:px-24 lg:px-16 sm:px-8 px-4 sm:py-6 py-0 sm:pb-0 pb-4'>
          <Navbar/>
          <div
            className='sm:mt-0 mt-12 flex xl:gap-6 gap-0 items-center sm:px-6 px-2 sm:flex-grow sm:flex-nowrap flex-wrap'>
            <div className='xl:w-[55%] lg:w-[58%] sm:w-[60%] w-full'>
              <div className='flex flex-col lg:gap-2 sm:gap-3 gap-2'>
                ...
                <p className='sm:text-base text-sm xl:w-[95%] text-[#6D7379] font-manrope'>Harness the power of
                  Nextalytic&apos;s transformative tech expertise. Explore Services to or Learn More about our digital
                  journey.</p>
